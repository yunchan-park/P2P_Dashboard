# train_classifier_randomforest.py
"""
데이터를 불러와 전처리 및 증강을 수행하고, RandomForest 분류 모델을 학습시킨 후 저장합니다.
"""
import os
import numpy as np
import pandas as pd
...
RANDOM_STATE = 42
# MODEL_OUT = "../trained_model/trained_classifier_model/auction_classifier_randomforest.joblib"

# ---------------------------
# 2) 모델 학습 및 평가 함수
# ---------------------------
def train_rf(X_train, y_train, params=None):
    """RandomForest 분류 모델을 학습시킵니다."""
    if params is None:
        params = {
            'n_estimators': 200,
            'max_depth': 10,
...
def main():
    ...
    # '절차적 종료' 케이스를 제외하고, 실제 낙찰된 데이터만 학습에 사용
