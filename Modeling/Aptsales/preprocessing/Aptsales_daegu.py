...
joblib.dump(final_model, '../predict_model/rf_model_daegu.joblib')
joblib.dump(te, '../predict_model/target_encoder_daegu.joblib')
joblib.dump(columns, '../predict_model/model_columns_daegu.joblib')
