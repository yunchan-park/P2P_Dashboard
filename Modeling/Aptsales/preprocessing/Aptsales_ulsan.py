...
joblib.dump(final_model, '../predict_model/rf_model_ulsan.joblib')
joblib.dump(te, '../predict_model/target_encoder_ulsan.joblib')
joblib.dump(columns, '../predict_model/model_columns_ulsan.joblib')
