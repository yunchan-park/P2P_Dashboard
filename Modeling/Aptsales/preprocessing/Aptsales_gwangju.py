...
joblib.dump(final_model, '../predict_model/rf_model_gwangju.joblib')
joblib.dump(te, '../predict_model/target_encoder_gwangju.joblib')
joblib.dump(columns, '../predict_model/model_columns_gwangju.joblib')
