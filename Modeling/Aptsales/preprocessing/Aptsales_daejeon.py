...
joblib.dump(final_model, '../predict_model/rf_model_daejeon.joblib')
joblib.dump(te, '../predict_model/target_encoder_daejeon.joblib')
joblib.dump(columns, '../predict_model/model_columns_daejeon.joblib')
