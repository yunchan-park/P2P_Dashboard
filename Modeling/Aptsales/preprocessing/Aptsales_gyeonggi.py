...
joblib.dump(final_model, '../predict_model/rf_model_gyeonggi.joblib')
joblib.dump(te, '../predict_model/target_encoder_gyeonggi.joblib')
joblib.dump(columns, '../predict_model/model_columns_gyeonggi.joblib')
